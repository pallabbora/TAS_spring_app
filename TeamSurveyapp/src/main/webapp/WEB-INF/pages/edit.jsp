...
<form action="update" method="get">
		<div class="form-row">
			...
			<div class="form-group">
				...
				<input type="text" class="form-control" id="lbleid" name="eid" value="${param.eid}">
					
			</div>
			<div class="form-group">
				<label for="lblfname">First Name </label> 
				<input type="text" class="form-control" id="lblfname" name="fname" value="${param.fname}">
					
			</div>
			<div class="form-group">
				<label for="lbllname">Last Name </label> 
				<input type="text" class="form-control" id="lbllname" name="lname" value="${param.lname}">
